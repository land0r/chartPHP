...
@section('content')
    ...
    <div class="box">
        <div class="box-header with-border">
            <span class="pull-right m-l-20 m-r-20 m-t-5"><a href="javascript: window.print();" title="Print page"><i class="fa fa-print"></i></a></span>

            @if ($entry->chart_type)
            <span class="pull-right m-l-20 m-r-20 m-t-5" id="import-to-pdf" data-chart="{{ $entry->name }}">
                <a style="cursor: pointer;" title="Import to PDF"><i class="fa fa-file-pdf-o"></i></a>
            </span>
            @endif
